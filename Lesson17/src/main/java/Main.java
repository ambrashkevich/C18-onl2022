...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Product apple = new Product(2, "Apple", 4);
        Product strawberry = new Product(3, "Strawberry", 3);
        Product bilberry = new Product(4, "Bilberry", 2);
        Product melon = new Product(5, "melon", 1);
        Product pumpkin = new Product(6, "pumpkin", 9);
        ...
        System.out.println("----------------------------------------------------------");
        shop.editProduct(new Product(5, "watermelon", 10));
        for (Product product : list) {
            System.out.println(product);
        }
        System.out.println("Редактируем один товар");
        System.out.println("----------------------------------------------------------");
